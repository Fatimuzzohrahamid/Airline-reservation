...
public  class Forgot extends JFrame implements ActionListener {
	...
	public Forgot() {
		...
		l1.setFont(new Font("Lucida Bright",Font.PLAIN,13));
		l1.setBounds(109,83,87,29);
		contentPane.add(l1);
		
		JLabel l2 = new JLabel("Name");
		l2.setFont(new Font("Lucida Bright",Font.PLAIN,13));
		l2.setBounds(109,122,87,29);
		contentPane.add(l2);
		
		JLabel l3 = new JLabel("Your Secrate name");
		l3.setFont(new Font("Lucida Bright",Font.PLAIN,13));
		l3.setBounds(109,154,156,27);
		contentPane.add(l3);
		
//		JLabel l4 = new JLabel("Answer:");
//		l4.setFont(new Font("Lucida Bright",Font.PLAIN,13));
//		l4.setBounds(109,192,104,21);
//		contentPane.add(l4);
		
		JLabel l5 = new JLabel("Password:");
		l5.setFont(new Font("Lucida Bright",Font.PLAIN,13));
//		l5.setBounds(109,224,87,29);
		l5.setBounds(109,192,104,21);
		contentPane.add(l5);
		
//		textfield of the username
		t1 = new JTextField();
		t1.setFont(new Font("Lucida Bright",Font.PLAIN,13));
...
//		
		...
		t2.setFont(new Font("Lucida Bright",Font.PLAIN,13));
		...
		t3.setFont(new Font("Lucida Bright",Font.PLAIN,13));
...
//		t4 = new JTextField();
//		t4.setFont(new Font("Lucida Bright",Font.PLAIN,13));
...
//		t4.setColumns(10);
		...
		t5 = new JTextField();
		t5.setFont(new Font("Lucida Bright",Font.PLAIN,13));
...
//		t5.setBounds(277,225,139,20);
		...
		b1.setFont(new Font("Lucida Bright",Font.PLAIN,13));
		...
		b2.setFont(new Font("Lucida Bright",Font.PLAIN,13));
//		b2.setBounds(426,188,85,29);
		b2.setBounds(426,268,101,29);
		...
		b3.setFont(new Font("Lucida Bright",Font.PLAIN,13));
...
//				b1 = Search button
				...
				while(rs.next()) {
					...
					t3.setText(rs.getString("S_name"));
					
				}
				
			}
			if(ae.getSource() == b2) {
				String sql = "select * from login where S_name = ?";
				PreparedStatement st = con.c.prepareStatement(sql);

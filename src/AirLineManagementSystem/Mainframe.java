...
JLabel NewLabel = new JLabel("");
	NewLabel.setIcon(new ImageIcon(ClassLoader.getSystemResource("AirLineManagementSystem//Images//front.jpg")));
	NewLabel.setBounds(0, 0, 1920, 990); 
//	NewLabel.setBounds(0, 0, 600, 650); 
	add(NewLabel); 
...
AirlineManagementSystem.setBounds(700, 60, 600,650);

...
public class Cancel extends JFrame { //Sixth
	...
	add(Cancellation);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("AirLineManagementSystem//Images//cancel.png"));
	...
	add(textField_4);
		...
		try{	
                    conn c = new conn();
                    String str = "INSERT INTO cancellation1 values('"+passenger_no+"', '"+cancellation_no+"', '"+cancellation_date+"', '"+ticket_id+"', '"+flight_code+"')";
